                ...
                for (var i = 0; i < lng; i++) {
                    $container.append(
                        tweet
                            ...
                            .replace('TWEET_TEXT', twitterwidget.ify.clean(data[i].text) )
                            ...
                            .replace('AGO', twitterwidget.timeAgo(data[i].created_at) )
                            .replace(/ID/g, data[i].id_str)
                        );
                 };
                 $item.replaceWith($container.children());
                 t++;
                 if (t < $twitterPortlets.length) twitterwidget.loadPortlet(t, $twitterPortlets);
            }
        });
    },
    init: function() {
        ...
        if ($twitterPortlets.length > 0) {
            ...
            twitterwidget.loadPortlet(t, $twitterPortlets);     
        };
    },
